...
class BlockchainService:
    ...
    def health(self) -> ChainHealth:
        if self.config.mode.value == "offline":
            return ChainHealth(ChainHealthStatus.NOT_CONFIGURED, ChainHealthStatus.NOT_CONFIGURED, self.config.mode.value)
        ...
        rofl = ChainHealthStatus.CONNECTED if self.config.rofl_service_url or self.config.rofl_app_id else ChainHealthStatus.NOT_CONFIGURED
